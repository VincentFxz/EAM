...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/sysmdl/eamSystemModule/">模块列表</a></li>
		<li class="active"><a href="${ctx}/sysmdl/eamSystemModule/form?id=${eamSystemModule.id}">模块<shiro:hasPermission name="sysmdl:eamSystemModule:edit">${not empty eamSystemModule.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="sysmdl:eamSystemModule:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
