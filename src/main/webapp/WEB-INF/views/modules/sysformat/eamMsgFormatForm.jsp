...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/sysformat/eamMsgFormat/">报文格式管理列表</a></li>
		<li class="active"><a href="${ctx}/sysformat/eamMsgFormat/form?id=${eamMsgFormat.id}">报文格式管理<shiro:hasPermission name="sysformat:eamMsgFormat:edit">${not empty eamMsgFormat.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="sysformat:eamMsgFormat:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
