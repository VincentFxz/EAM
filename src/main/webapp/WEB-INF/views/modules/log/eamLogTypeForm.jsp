...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/log/eamLogType/">流水日志列表</a></li>
		<li class="active"><a href="${ctx}/log/eamLogType/form?id=${eamLogType.id}">流水日志<shiro:hasPermission name="log:eamLogType:edit">${not empty eamLogType.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="log:eamLogType:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
