...
<head>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            var columnListSize = ${fn:length(genTable.columnList)};
            $("#btnAddCol").click(function () {
                var rowTemplate = $("#rowTemplate").html();
                rowTemplate = rowTemplate.replace(new RegExp(/replace_index/g), columnListSize++);
                $("#contentTable tr:last").after("<tr></tr>");
                console.log($("#contentTable tr:last"));
                $("#contentTable tr:last").append(rowTemplate);
            });
        });
    </script>
</head>
    ...
    <fieldset>
        ...
        <div class="control-group">
            <table id="contentTable" class="table table-striped table-bordered table-condensed">
                ...
                <tr>
                    <td colspan="15"><a id="btnAddCol" class="btn" href="#"><i class="icon-plus"></i> 新增</a></td>
                </tr>
                </thead>
                <tbody>
...
<div id="template" style="display:none;">
    <table>
        <tr id="rowTemplate" style="display:none;">
            <td nowrap>
                <input type="hidden" name="columnList[replace_index].id"/>
                <input type="hidden" name="columnList[replace_index].delFlag" value="0"/>
                <input type="hidden" name="columnList[replace_index].genTable.id"/>
                <input type="text" name="columnList[replace_index].name"
                       class="required"/>
            </td>
            <td>
                <input type="text" name="columnList[replace_index].comments"
                       maxlength="200" class="required"
                       style="width:100px;"/>
            </td>
            <td nowrap>
                <input type="text" name="columnList[replace_index].jdbcType"
                       class="required"/>
            </td>
            <td>
                <select name="columnList[replace_index].javaType" class="required input-mini"
                        style="width:85px;*width:75px">
                    <c:forEach items="${config.javaTypeList}" var="dict">
            ...
            <td>
                <input type="text" name="columnList[replace_index].javaField"
                       maxlength="200" class="required input-small"/>
            </td>
            <td>
                <input type="checkbox" name="columnList[replace_index].isPk"
                       value="1"/>
            </td>
            <td>
                <input type="checkbox" name="columnList[replace_index].isNull"
                       value="1"/>
            </td>
            <td>
                <input type="checkbox" name="columnList[replace_index].isInsert"
                       value="1"/>
            </td>
            <td>
                <input type="checkbox" name="columnList[replace_index].isEdit"
                       value="1"/>
            </td>
            <td>
                <input type="checkbox" name="columnList[replace_index].isList"
                       value="1"/>
            </td>
            <td>
                <input type="checkbox" name="columnList[replace_index].isQuery"
                       value="1"/>
            </td>
            <td>
                <select name="columnList[replace_index].queryType" class="required input-mini">
                    <c:forEach items="${config.queryTypeList}" var="dict">
            ...
            <td>
                <select name="columnList[replace_index].showType" class="required"
                        style="width:100px;">
                    <c:forEach items="${config.showTypeList}" var="dict">
                        <option value="${dict.value}"
                                title="${dict.description}">${dict.label}</option>
            ...
            <td>
                <input type="text" name="columnList[replace_index].dictType"
                       maxlength="200" class="input-mini"/>
            </td>
            <td>
                <input type="text" name="columnList[replace_index].sort"
                       maxlength="200" class="required input-min digits"/>
            </td>
        </tr>
    </table>
