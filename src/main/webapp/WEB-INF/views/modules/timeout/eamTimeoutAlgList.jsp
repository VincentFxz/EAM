...
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/timeout/eamTimeoutAlg/">超时时间管理列表</a></li>
		<shiro:hasPermission name="timeout:eamTimeoutAlg:edit"><li><a href="${ctx}/timeout/eamTimeoutAlg/form">超时时间管理添加</a></li></shiro:hasPermission>
	</ul>
		...
		<c:forEach items="${page.list}" var="eamTimeoutAlg">
			<tr>
				...
				<shiro:hasPermission name="timeout:eamTimeoutAlg:edit"><td>
					...
					<a href="${ctx}/timeout/eamTimeoutAlg/delete?id=${eamTimeoutAlg.id}" onclick="return confirmx('确认要删除该超时时间管理吗？', this.href)">删除</a>
