...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/flow/eamFlowCtlAlg/">流控算法管理模块列表</a></li>
		<li class="active"><a href="${ctx}/flow/eamFlowCtlAlg/form?id=${eamFlowCtlAlg.id}">流控算法管理模块<shiro:hasPermission name="flow:eamFlowCtlAlg:edit">${not empty eamFlowCtlAlg.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="flow:eamFlowCtlAlg:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
