 ...
 */
package com.dc.smarteam.modules.layer.web;
...
import com.dc.smarteam.modules.layer.service.EamAaLayerService;
 ...
 */
@Controller
@RequestMapping(value = "${adminPath}/layer/eamAaLayer")
public class EamAaLayerController extends BaseController {
	...
	@RequiresPermissions("layer:eamAaLayer:view")
	...
	public String list(EamAaLayer eamAaLayer, HttpServletRequest request, HttpServletResponse response, Model model) {
		...
		return "modules/layer/eamAaLayerList";
	}
	...
	public String form(EamAaLayer eamAaLayer, Model model) {
		...
		return "modules/layer/eamAaLayerForm";
	}

	@RequiresPermissions("layer:eamAaLayer:edit")
	...
	public String save(EamAaLayer eamAaLayer, Model model, RedirectAttributes redirectAttributes) {
		...
		addMessage(redirectAttributes, "保存架构层次管理成功");
		return "redirect:"+Global.getAdminPath()+"/layer/eamAaLayer/?repage";
	}
	...
	public String delete(EamAaLayer eamAaLayer, RedirectAttributes redirectAttributes) {
		...
		addMessage(redirectAttributes, "删除架构层次管理成功");
		return "redirect:"+Global.getAdminPath()+"/layer/eamAaLayer/?repage";
	}
