 ...
 */
package com.dc.smarteam.modules.interfacelist.web;
...
import com.dc.smarteam.modules.interfacelist.service.EamInterfaceService;
 ...
 */
@Controller
@RequestMapping(value = "${adminPath}/interfacelist/eamInterface")
public class EamInterfaceController extends BaseController {
	...
	@RequiresPermissions("interfacelist:eamInterface:view")
	...
	public String list(EamInterface eamInterface, HttpServletRequest request, HttpServletResponse response, Model model) {
		...
		return "modules/interfacelist/eamInterfaceList";
	}
	...
	public String form(EamInterface eamInterface, Model model) {
		...
		return "modules/interfacelist/eamInterfaceForm";
	}

	@RequiresPermissions("interfacelist:eamInterface:edit")
	...
	public String save(EamInterface eamInterface, Model model, RedirectAttributes redirectAttributes) {
		...
		return "redirect:"+Global.getAdminPath()+"/interfacelist/eamInterface/?repage";
	}
